import type {
  UserRole, LessonType, LessonStatus, AbsenceCategory,
  PaymentPlan, PieceStatus, ResourceType, ResourceLevel,
  LessonCategory, MakeupDirection, CancelledByRole,
} from './enums';
...
export interface CurriculumResourceTag {
  resource_id: string;
  tag_id: string;
}
